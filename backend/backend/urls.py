...
from courses.views import create_or_uptate_student_choices, get_courses_teacher, create_course, create_options_list, add_course_to_options_list, get_student_options_lists
